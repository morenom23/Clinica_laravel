...
<body class="font-sans antialiased dark:bg-black dark:text-white/50">
    ...
    @if (Route::has('login'))
        <nav class="login-registro">
            @auth
                <a href="{{ url('/dashboard') }}" class="login-clinica"
                    class="rounded-md px-3 py-2 text-black ring-1 ring-transparent transition hover:text-black/70 focus:outline-none focus-visible:ring-[#FF2D20] dark:text-white dark:hover:text-white/80 dark:focus-visible:ring-white">
                    Dashboard
                </a>
            @else
                <div class="log-reg">
                    <a href="{{ route('login') }}" class="login-clinica">
                        Log in
                    </a>
                    <span class="span">/</span>

                    @if (Route::has('register'))
                        <a href="{{ route('register') }}" class="login-clinica">
                            Register
                        </a>
                    @endif
                </div>
    ...
    <div class="cuerpo">
        <div class="tex-cuerpo">
            <p>
                Por favor inicie sesión para agendar su cita <br>
            </p><br>
            <p class="horarios">Horarios: Lunes a viernes <br>
